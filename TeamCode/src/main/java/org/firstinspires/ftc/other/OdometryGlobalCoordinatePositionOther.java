 ...
 */
public class OdometryGlobalCoordinatePositionOther implements Runnable{
    //Odometry wheels
     ...
     */
    public OdometryGlobalCoordinatePositionOther(DcMotor verticalEncoderLeft, DcMotor verticalEncoderRight, DcMotor horizontalEncoder, double COUNTS_PER_INCH, int threadSleepDelay, double startingPositionX, double startingPositionY, double startingOrientation ){
        this.verticalEncoderLeft = verticalEncoderLeft;
        this.verticalEncoderRight = verticalEncoderRight;
        this.horizontalEncoder = horizontalEncoder;
        sleepTime = threadSleepDelay;
        this.robotGlobalXCoordinatePosition = startingPositionX*COUNTS_PER_INCH;
        this.robotGlobalYCoordinatePosition = startingPositionY*COUNTS_PER_INCH;
