 ...
 */
@TeleOp(name = "Odometry System Calibration Scale", group = "Calibration")
//Disabled
public class OdometryCalibrationScale2Field extends LinearOpMode {
    //Drive motors
    ...
    final double WHEEL_DIAMETER = 2.3622; //in inches, 38mm for odometry aluminum omni wheels 60 mm rev wheel
